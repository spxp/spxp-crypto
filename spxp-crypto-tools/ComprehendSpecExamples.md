...
The [SPXP Specification v0.3](https://github.com/spxp/spxp-specs/blob/v0.3/SPXP-Spec.md)
...
The keypairs used for the examples are listed in [Appendix B](https://github.com/spxp/spxp-specs/blob/v0.3/SPXP-Spec.md#appendix-b-private-keys-used-in-examples)
...
[Profile keypair of “Emerald City”](./spec-examples/emerald-city-profile-keypair.json)  
[Profile keypair of “Hill Valley”](./spec-examples/hill-valley-profile-keypair.json)  
[Profile keypair of “Crypto Alice”](./spec-examples/alice-profile-keypair.json)  
[Profile keypair of “Crypto Bob”](./spec-examples/bob-profile-keypair.json)  
[Symmetric AES key “ABCD.1234” used in chapter 11.5](./spec-examples/symkey-ABCD1234.json)  
...
[Ephemeral Connection Establishment Key between “Crypto Alice” and “Crypto Bob” used in chapter 14](./spec-examples/alice-bob-ece-key.json)  

## Signed Profile of “Crypto Alice” in Chapter 8.1
...
## Certificate for “Crypto Bob” signed by “Crypto Alice” in Chapter 8.2
...
## Individual Posts in Chapter 10
As [specified in 10.1](https://github.com/spxp/spxp-specs/blob/v0.3/SPXP-Spec.md#101-signing-and-encrypting-posts),
posts are signed individually. Each post in the example in chapter 10 can be signed as follows:
```
...
## Signed and Encrypted private data in Chapter 11.5
...
## Signed Profile of “Crypto Alice” in Chapter 14.2
You can sign the profile in chapter 45.2 yourself as follows:
```
...
## Signed Connection Package of “Crypto Alice” for “Crypto Bob” in Chapter 14.3
...
## Signed Connection Request of “Crypto Alice” for “Crypto Bob” in Chapter 14.5
...
## Encrypted Connection Request of “Crypto Alice” for “Crypto Bob” in Chapter 14.7
The `connection_request` request sent in chapter 14.7 contains the encrypted
...
## Encrypted Connection Package for “Crypto Alice” from “Crypto Bob” in Chapter 14.8
The `connection_accept` request sent in chapter 14.8 contains the encrypted
...
## Encrypted Connection Package for “Crypto Bob” from “Crypto Alice” in Chapter 14.8
The connection package Alice has created and signed in chapter 14.3 appears in
the server response in chapter 14.8 encrypted with the Ephemeral Connection
